...
// druid-ext:druid:ui/ui
var require_ui = __commonJS({
  "druid-ext:druid:ui/ui"(exports, module) {
    module.exports = window["druid-extension"]["druid:ui/ui"];
  }
});

// druid-ext:druid:ui/utils
var require_utils = __commonJS({
  "druid-ext:druid:ui/utils"(exports, module) {
    module.exports = window["druid-extension"]["druid:ui/utils"];
  }
});

// druid-ext:druid:ui/plattform
var require_plattform = __commonJS({
  "druid-ext:druid:ui/plattform"(exports, module) {
    module.exports = window["druid-extension"]["druid:ui/plattform"];
  }
});
...
function emit(nodeid, event, e) {
  (0, import_ui2.log)(`Emit called for nodeid: ${nodeid}, event: ${event}`);
  const callbacks = callbackMap[nodeid];
  const result = callbacks?.[event]?.(e);
  if (result instanceof Promise) {
    result.then(() => (0, import_ui2.rerender)());
  }
}
var registerHooks = (id, fnresult) => {
  switch (true) {
    case !!fnresult.init:
      (0, import_ui2.setHook)(id, "init");
      callbackMap[id] = {
        ...callbackMap[id],
        init: fnresult.init
      };
...
var d2 = createDFunc(import_ui.d);
...
var import_plattform = __toESM(require_plattform(), 1);
var request = rawAsyncToPromise(import_plattform.request);
