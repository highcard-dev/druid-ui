...
const { d, log } = imports['docs:adder/ui'];
let gen = (function* init () {
  ...
  function trampoline3(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
    ...
    _debugLog('[iface="docs:adder/ui", function="d"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'd');
    const ret = d(result0, {
      prop: result3,
      on: result6,
    }, variant9);
    _debugLog('[iface="docs:adder/ui", function="d"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    ...
    _debugLog('[iface="docs:adder/ui", function="d"][Instruction::Return]', {
      funcName: 'd',
      paramCount: 0,
      postReturn: false
    });
  ...
  function trampoline4(arg0, arg1) {
    ...
    var len0 = arg1;
    var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="docs:adder/ui", function="log"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'log');
    log(result0);
    _debugLog('[iface="docs:adder/ui", function="log"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="docs:adder/ui", function="log"][Instruction::Return]', {
      funcName: 'log',
      paramCount: 0,
      postReturn: false
    });
  ...
  ({ exports: exports1 } = yield instantiateCore(yield module0, {
    '[export]docs:adder/initcomponent': {
  ...
  postReturn0 = exports1['cabi_post_docs:adder/initcomponent#[constructor]event'];
  postReturn1 = exports1['cabi_post_docs:adder/initcomponent#[method]event.prevent-default'];
  postReturn2 = exports1['cabi_post_docs:adder/initcomponent#[method]event.stop-propagation'];
  postReturn3 = exports1['cabi_post_docs:adder/initcomponent#[method]event.value'];
  postReturn4 = exports1['cabi_post_docs:adder/initcomponent#[method]event.checked'];
  postReturn5 = exports1['cabi_post_docs:adder/initcomponent#init'];
  postReturn6 = exports1['cabi_post_docs:adder/initcomponent#emit'];
  ...
  class Event{
    constructor(arg0, arg1) {
      ...
      _debugLog('[iface="docs:adder/initcomponent", function="[constructor]event"] [Instruction::CallWasm] (async? false, @ enter)');
      const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentConstructorEvent');
      ...
      _debugLog('[iface="docs:adder/initcomponent", function="[constructor]event"][Instruction::Return]', {
  ...
  Event.prototype.preventDefault = function preventDefault() {
    ...
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.prevent-default"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentMethodEventPreventDefault');
    initcomponentMethodEventPreventDefault(handle0);
    endCurrentTask(0);
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.prevent-default"][Instruction::Return]', {
  ...
  Event.prototype.stopPropagation = function stopPropagation() {
    ...
    var handle0 = handleTable0[(handle1 << 1) + 1] & ~T_FLAG;
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.stop-propagation"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentMethodEventStopPropagation');
    initcomponentMethodEventStopPropagation(handle0);
    endCurrentTask(0);
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.stop-propagation"][Instruction::Return]', {
  ...
  Event.prototype.value = function value() {
    ...
    var handle0 = handleTable0[(handle1 << 1) + 1] & ~T_FLAG;
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.value"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentMethodEventValue');
    ...
    var result2 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr2, len2));
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.value"][Instruction::Return]', {
  ...
  Event.prototype.checked = function checked() {
    ...
    var handle0 = handleTable0[(handle1 << 1) + 1] & ~T_FLAG;
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.checked"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentMethodEventChecked');
    const ret = initcomponentMethodEventChecked(handle0);
    endCurrentTask(0);
    var bool2 = ret;
    _debugLog('[iface="docs:adder/initcomponent", function="[method]event.checked"][Instruction::Return]', {
      funcName: '[method]event.checked',
      paramCount: 1,
      postReturn: true
    });
    const retCopy = bool2 == 0 ? false : (bool2 == 1 ? true : throwInvalidBool());
  ...
  function init() {
    _debugLog('[iface="docs:adder/initcomponent", function="init"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentInit');
    const ret = initcomponentInit();
    endCurrentTask(0);
    var ptr0 = dataView(memory0).getUint32(ret + 0, true);
    var len0 = dataView(memory0).getUint32(ret + 4, true);
    var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="docs:adder/initcomponent", function="init"][Instruction::Return]', {
      funcName: 'init',
      paramCount: 1,
      postReturn: true
    });
  ...
  function emit(arg0, arg1, arg2) {
    ...
    _debugLog('[iface="docs:adder/initcomponent", function="emit"] [Instruction::CallWasm] (async? false, @ enter)');
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'initcomponentEmit');
    initcomponentEmit(ptr0, len0, ptr1, len1, handle2);
    endCurrentTask(0);
    _debugLog('[iface="docs:adder/initcomponent", function="emit"][Instruction::Return]', {
      funcName: 'emit',
      paramCount: 0,
      postReturn: true
    });
  ...
  initcomponentConstructorEvent = exports1['docs:adder/initcomponent#[constructor]event'];
  initcomponentMethodEventPreventDefault = exports1['docs:adder/initcomponent#[method]event.prevent-default'];
  initcomponentMethodEventStopPropagation = exports1['docs:adder/initcomponent#[method]event.stop-propagation'];
  initcomponentMethodEventValue = exports1['docs:adder/initcomponent#[method]event.value'];
  initcomponentMethodEventChecked = exports1['docs:adder/initcomponent#[method]event.checked'];
  initcomponentInit = exports1['docs:adder/initcomponent#init'];
  initcomponentEmit = exports1['docs:adder/initcomponent#emit'];
  const initcomponent = {
    Event: Event,
    emit: emit,
    init: init,
  ...
  return { initcomponent, 'docs:adder/initcomponent': initcomponent,  };
})();
