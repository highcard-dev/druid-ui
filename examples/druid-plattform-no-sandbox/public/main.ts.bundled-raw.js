...
druidUiElement.extensionObject = {
  "druid:ui/plattform": {
    request: $36561bb1074897e9$export$e36240994a645832(
    ...
    loadFileFromDeployment: $36561bb1074897e9$export$e36240994a645832(async (path) => {
      console.log(`Loading file from deployment: ${path}`);
      await sleep(1e3);
      return "test=hallo";
    }),
    saveFileToDeployment: $36561bb1074897e9$export$e36240994a645832(
      async (path, content) => {
        console.log(
...
druidUiElement.setAttribute("entrypoint", "/druid.bundled.js");
